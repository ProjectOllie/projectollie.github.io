...
if (e9Manager === undefined || e9Manager.init === false)
	...
	e9Manager = manager;
        ...
        var e9Page = 
	 {
	   ...
	   host: "a.tribalfusion.com",
  	   busterframe: (e9 && e9.busterframe) || "http://www.mobafire.com/tfBuster.htm",
  	   busterDomain: "",
	   site: "mobafirecom",
	   adSpace: "dotafire",
	   tagKey: "1228307269",
	   ...
	   tagOptions: {"VDX_2.0":{"teaser":{"zindex":5}}, "snackBar":{"snackBarClose":true, "serveSnackBar":true}},
...
else
 {
   if (e9 !== undefined) 
    {
      e9Manager.setSite("mobafirecom","dotafire");
